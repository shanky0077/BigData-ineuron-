...
FILE_PATH = "E:\INeuron\BIGDATA_CERTIFICATION\Kafka\KafkaDemo\cardekho_dataset.csv"
columns=['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
       'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
       'seats', 'selling_price']

API_KEY = 'MKBUUUAERGF4CLX2'
ENDPOINT_SCHEMA_URL  = 'https://psrc-mw0d1.us-east-2.aws.confluent.cloud'
API_SECRET_KEY = 'ByNlpG8vd8j8vDHzdSDBOHLXDkvKZGhl5bES0M5YCk4oF7ABYsdWRW9axcMeOGu2'
BOOTSTRAP_SERVER = 'pkc-ymrq7.us-east-2.aws.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'AEXNWXJKUJSPKP6H'
SCHEMA_REGISTRY_API_SECRET = 'iE8ZpoER0/hmQJzk56+909Bm73sx/ee0YTacXOswZ/laGOzXI+i0mhqDy2o1hF8I'
